...
function initTableChartData() {
  ...
  gatewaysFirmwareVersionTableData.value =
    tmpGatewaysFirmwareVersionTableData.value[selectedGatewaysFw.value] === undefined
      ? []
      : tmpGatewaysFirmwareVersionTableData.value[selectedGatewaysFw.value]
  ...
  nodesFirmwareVersionTableData.value =
    tmpNodesFirmwareVersionTableData.value[selectedNodesFw.value] === undefined
      ? []
      : tmpNodesFirmwareVersionTableData.value[selectedNodesFw.value]
  //chart data
  const tmpGatewaysFirmwareVersionBarChartData = gatewaysData.value.reduce(
    (acc, item) => {
  ...
  updateData(
    gatewaysFirmwareVersionBarChart.value,
    tmpGatewaysFirmwareVersionBarChartData.fwVersion,
    tmpGatewaysFirmwareVersionBarChartData.count
  )

  const tmpNodesFirmwareVersionBarChartData = nodesData.value.reduce(
    (acc, item) => {
      const { fwVersion } = item
      const index = acc.fwVersion.indexOf(fwVersion)
      if (index === -1) {
  ...
  updateData(
    nodesFirmwareVersionBarChart.value,
    tmpNodesFirmwareVersionBarChartData.fwVersion,
    tmpNodesFirmwareVersionBarChartData.count
  )
}
...
function renderBarChart() {
  ...
  const gatewaysFirmwareVersionChartCtx =
    gatewaysFirmwareVersionBarChartCanvas.value.getContext('2d')
  gatewaysFirmwareVersionBarChart = shallowRef(
    new Chart(gatewaysFirmwareVersionChartCtx, {
      type: 'bar',
  ...
  nodesFirmwareVersionBarChart = shallowRef(
    new Chart(nodesFirmwareVersionChartCtx, {
      type: 'bar',
  ...
  <div class="flex">
    ...
    <div class="flex flex-col w-screen">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-4 gap-3">
          <div class="bg-bkg-secondary rounded-[24px] p-[2px] grid grid-rows-2">
            <div class="gap-[12px] flex-1 py-[12px] px-[20px] flex flex-col justify-center">
              <div class="flex justify-between">
                <h1 class="text-label-primary text-lg font-semibold">Total Devices</h1>
                <img
                  v-if="!isDark"
                  src="../../assets/device-icon.svg"
                  height="30px"
                  width="30px"
                  alt=""
                />
                <img
                  v-if="isDark"
                  src="../../assets/device-icon-white.svg"
                  height="30px"
                  width="30px"
                  alt=""
                />
              ...
              <h1
                class="text-accent-1 self-center text-center text-[30px] sm:text-[50px] font-medium"
              >
                {{ totalDevices }}
              </h1>
            </div>
            <div class="flex gap-6 px-[20px] pb-[20px]">
              ...
              >
                <div class="flex justify-between items-center">
                  <p class="text-label-primary text-xs sm:text-[16px] font-semibold">Gateways</p>
                  <img
                    v-if="!isDark"
                    src="../../assets/gateway-icon.svg"
                    height="24px"
                    width="24px"
                    alt=""
                  />
                  <img
                    v-if="isDark"
                    src="../../assets/gateway-icon-white.svg"
                    height="24px"
                    width="24px"
                    alt=""
                  />
              ...
              >
                <div class="flex justify-between items-center">
                  <p class="text-label-primary text-xs sm:text-[16px] font-semibold">Nodes</p>
                  <img
                    v-if="!isDark"
                  ...
                  <img
                    v-if="isDark"
                    src="../../assets/node-icon-white.svg"
                    height="24px"
                    width="24px"
                    alt=""
                  />
          ...
          <div class="grid grid-rows-2 gap-3">
            <div class="flex flex-col gap-1 bg-bkg-secondary rounded-[24px] p-[2px]">
              ...
              >
                <h1 class="text-label-primary text-center text-lg font-semibold">Online</h1>
            ...
            <div class="flex flex-col gap-1 bg-bkg-secondary rounded-[24px] p-[2px]">
              <div
                class="gap-[12px] flex-1 py-[12px] px-[20px] bg-bkg-primary shadow border border-bkg-secondary flex flex-col justify-center rounded-[6px] sm:rounded-[22px]"
              >
                <h1 class="text-label-primary text-center text-lg font-semibold">Offline</h1>
          ...
          <div
            v-if="isThereOfflineGateway && !isNoGateways"
          ...
          >
            <div class="flex flex-col gap-2">
              ...
              <div class="flex flex-col gap-2 h-[280px] overflow-y-auto">
                <div
                  v-for="data in offlineGatewaysList"
                  @click="showOfflineGatewayDetail(data.id)"
          ...
          >
            <div class="flex flex-col gap-2 h-full">
              ...
              >
                ...
                <p class="text-sm text-label-primary font-semibold">
                  Relax, all your gateways are online!
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div class="flex flex-col gap-2 h-full">
              ...
              >
                ...
                <p class="text-sm text-label-primary font-semibold">
                  Ooops, seems like you don't have any gateways yet
                </p>
              </div>
            </div>
          </div>
          <!-- nodes -->
          <div
            v-if="isThereOfflineNode && !isNoNodes"
            class="flex-1 p-[20px] bg-bkg-primary rounded-[6px] sm:rounded-[24px] shadow border border-bkg-secondary flex flex-col justify-start"
          >
            <div class="flex flex-col gap-2">
              <div class="flex justify-between items-center">
              ...
              <div class="flex flex-col gap-2 h-[280px] overflow-y-auto">
                <div
                  v-for="data in offlineNodesList"
          ...
          >
            <div class="flex flex-col gap-2 h-full">
              ...
              >
                <img src="../../assets/smile-icon.svg" alt="" height="120px" width="120px" />
                <p class="text-sm text-label-primary font-semibold">
                  Relax, all your nodes are online!
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div class="flex flex-col gap-2 h-full">
              ...
              >
                <img src="../../assets/oops-icon.svg" alt="" height="120px" width="120px" />
                <p class="text-sm text-label-primary font-semibold">
                  Ooops, seems like you don't have any nodes yet
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="p-[20px] flex flex-col gap-[20px]">
          ...
          <div class="mx-8 grid grid-row gap-4 md:gap-8">
            <div class="flex flex-col gap-10">
              <div class="flex flex-col gap-4">
                <div class="flex gap-4 w-full">
                  ...
                  >
                    ...
                    <div class="flex items-center gap-3" v-if="selectedDeviceType !== 'All'">
                      ...
                      <div class="flex gap-1">
                        <div
                          @click="removeGatewaysGroup(group)"
                          ...
                          <div v-for="(option, index) in type.groups" :key="index" class="">
                            <label class="cursor-pointer select-none">
                              <input
                                ...
                                :disabled="
                                  gatewaysGroupBy.length >= 2 && !gatewaysGroupBy.includes(option)
                                "
                              />
                              <div
                  ...
                  <div class="tab">
                    <button
                      ...
                      :key="tab.value"
                      @click="changeGatewayView(tab.value)"
                      class="gateway-tab outline-none"
                      :value="index"
                      :id="tab.value"
                      :class="selectedGatewaysView === tab.value ? 'active' : ''"
                    >
                      {{ tab.title }}
                    </button>
                  </div>
                ...
                <div :class="selectedGatewaysView === 'card' ? '' : 'hidden'">
                  ...
                  >
                    <div
                      ...
                      @click="goToGatewayDetailPage(data.device)"
                    >
                      <a :href="`/device-detail/${data.device}`" target="_blank" @click.prevent>
                        ...
                        <div class="grid grid-cols-1 xl:grid-cols-2 justify-between">
                          <div class="flex flex-col gap-1">
                            ...
                            <div class="flex text-[10px] sm:text-xs md:text-sm gap-1 items-center">
                              <div class="flex flex-col gap-1">
                                ...
                                <p class="text-label-primary font-semibold opacity-90">
                                  {{ data._time }}
                                </p>
                              </div>
                              <div class="dropdown">
                                ...
                                />
                                <div class="dropdown-content w-full">{{ data.lastHeard }} ago</div>
                              </div>
                            </div>
                            <div class="flex text-[10px] sm:text-xs md:text-sm gap-1">
                          ...
                          <div class="flex flex-col gap-1">
                            ...
                            <div class="flex text-[10px] sm:text-xs md:text-sm gap-1 items-center">
                              <div class="flex flex-col gap-1">
                                <p class="text-label-primary font-medium opacity-80">
                                  Reset Reason
                                </p>
                                <p class="text-label-primary font-semibold opacity-90">
                  ...
                  <div
                    v-if="gatewaysGroupBy.length == 1"
                    v-for="(value, key) in groupedGatewaysData"
                  ...
                  <div v-if="gatewaysGroupBy.length > 1" class="flex flex-col gap-4">
                    <div
                      v-for="(outerGroup, outerKey) in groupedGatewaysData"
                      :key="outerKey"
                    ...
                    >
                      ...
                      <div
                        v-for="(innerGroup, innerKey) in outerGroup"
                        :key="innerKey"
                ...
                <div
                  :class="selectedGatewaysView === 'table' ? '' : 'hidden'"
                  class="flex flex-col gap-4"
                >
                  <div class="w-fit">
                    <SearchBar
              ...
              <div class="flex flex-col gap-4">
                <div class="flex gap-4 w-full">
                          ...
                          <div v-for="(option, index) in type.groups" :key="index" class="">
                            <label class="cursor-pointer select-none">
                              <input
                                ...
                                :disabled="
                                  nodesGroupBy.length >= 2 && !nodesGroupBy.includes(option)
                                "
                              />
                              <div
                  ...
                  <div class="tab">
                    <button
                      v-for="(tab, index) in tabs"
                      :key="tab.value"
                      @click="changeNodeView(tab.value)"
                      class="node-tab outline-none"
                      :value="index"
                      :id="tab.value"
                      :class="selectedNodesView === tab.value ? 'active' : ''"
                    >
                      {{ tab.title }}
                    </button>
                  </div>
                ...
                <div :class="selectedNodesView === 'card' ? '' : 'hidden'">
                  <div
                    v-if="nodesGroupBy.length === 0"
                    class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 max-h-[800px] overflow-y-scroll overflow-x-visible min-h-[200px]-[200px] pb-2"
                  >
                    <div
                      @click="goToDeviceDetailPage(data.device)"
                  ...
                  <div v-if="nodesGroupBy.length > 1" class="flex flex-col gap-4">
                    <div
                      v-for="(outerGroup, outerKey) in groupedNodesData"
                      :key="outerKey"
                      class="rounded-[16px] bg-bkg-secondary p-[10px] flex flex-col gap-4 max-h-[800px] min-h-[200px] overflow-y-scroll overflow-x-visible"
                    >
                      <div class="p-[6px]">
                      ...
                      >
                        ...
                        <div class="grid grid-cols-3">
                          ...
                          >
                            <a
                              :href="`/device-detail/${data.device}`"
                              target="_blank"
                              @click.prevent
                            >
                              <div class="flex justify-between items-center">
                ...
                <div
                  :class="selectedNodesView === 'table' ? '' : 'hidden'"
                  class="flex flex-col gap-4"
                >
                  <div class="w-fit">
                    <SearchBar
                  ...
                  >
                    ...
                    <template #item-operation="item">
                      <svg
                        ...
                        @click="goToDeviceDetailPage(item.device)"
                      >
                        <path
                          d="M13 7H22V9H13V7ZM13 15H22V17H13V15ZM16 11H22V13H16V11ZM13 12L8 7V11H2V13H8V17L13 12Z"
                          fill="#353535"
                          fill-opacity="0.6"
                        />
                      </svg>
        ...
        >
          <h1 class="text-label-primary text-lg font-semibold">Firmware Versions</h1>
          <div>
            <div class="py-2 px-4 rounded-md bg-bkg-tertiary w-fit">
              <h1 class="text-label-primary text-md font-medium">Gateways</h1>
            </div>
            <div class="grid grid-cols-3 gap-6">
              ...
              <div class="flex flex-col gap-2">
                <div class="custom-select-2">
                  <select
                    name="availableGatewaysFw"
                    id="availableGatewaysFw"
                    v-model="selectedGatewaysFw"
                ...
                <EasyDataTable
                  ...
                  table-class-name="customize-table"
                  :headers="header"
                  :items="gatewaysFirmwareVersionTableData"
                  theme-color="#1363df"
                >
                </EasyDataTable>
              </div>
          ...
          <div>
            <div class="py-2 px-4 rounded-md bg-bkg-tertiary w-fit">
              <h1 class="text-label-primary text-md font-medium">Nodes</h1>
            </div>
            <div class="grid grid-cols-3 gap-6">
              <div class="col-span-2">
              ...
              <div class="flex flex-col gap-2">
                <div class="custom-select-2">
                  <select
                    name="availableNodesFw"
                    id="availableNodesFw"
                    v-model="selectedNodesFw"
                ...
                <EasyDataTable
                  ...
                  table-class-name="customize-table"
                  :headers="header"
                  :items="nodesFirmwareVersionTableData"
                  theme-color="#1363df"
                >
                </EasyDataTable>
              </div>
